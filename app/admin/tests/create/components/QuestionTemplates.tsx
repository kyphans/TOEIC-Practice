...
function DraggableTemplateItem({ template, index }: { template: Question; index: number }) {
...
export function QuestionTemplates({ activeTab, setActiveTab, draggedTemplate }: QuestionTemplatesProps) {
  return (
    <div className="brutalist-container">
      <Tabs defaultValue="listening" onValueChange={(value) => setActiveTab(value as "listening" | "reading")}>
