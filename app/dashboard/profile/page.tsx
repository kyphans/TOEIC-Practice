    ...
    <div className="space-y-8">
      ...
      <Tabs defaultValue="profile" className="w-full">
        <TabsList className="grid grid-cols-4 mb-8">
          <TabsTrigger
            value="profile"
            className="brutalist-button data-[state=active]:bg-blue-500 data-[state=active]:text-white"
          >
        ...
        <TabsContent value="notifications">
          <div className="brutalist-container">
            ...
            <div className="space-y-6">
              ...
              <div className="brutalist-card p-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm">Get reminders about scheduled tests</p>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
              ...
              <div className="brutalist-card p-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm">Receive notifications about your test scores</p>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
              ...
              <div className="brutalist-card p-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm">Get notified when new tests are added</p>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
              ...
              <Button className="brutalist-button">Save Notification Settings</Button>
            </div>
          </div>
        </TabsContent>
